  ...
  companion object {
    ...
    fun data(): Iterable<Array<Any>> {
      return listOf(
        ...
        arrayOf(
          "An avatar filename: file:///data/user/0/com.vprimex.messenger/files/avatars/%2B447700900099",
          "An avatar filename: file:///data/user/0/com.vprimex.messenger/files/avatars/E164:<3106a51b>"
        ),
        arrayOf(
        ...
        arrayOf(
          "An avatar email filename: file:///data/user/0/com.vprimex.messenger/files/avatars/abc@signal.org",
          "An avatar email filename: file:///data/user/0/com.vprimex.messenger/files/avatars/a...@..."
        ),
        arrayOf(
