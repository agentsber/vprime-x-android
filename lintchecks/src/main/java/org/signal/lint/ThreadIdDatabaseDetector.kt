...
class ThreadIdDatabaseDetector : Detector(), SourceCodeScanner {
    ...
    return object : UElementHandler() {
      override fun visitClass(node: UClass) {
        ...
        val implementsReference = node.interfaces.any { nodeInterface ->
          "com.vprimex.messenger.database.ThreadIdDatabaseReference" == nodeInterface.qualifiedName
        }
  ...
  companion object {
    ...
    private val EXEMPTED_CLASSES = setOf("com.vprimex.messenger.database.ThreadDatabase")
  }
}
