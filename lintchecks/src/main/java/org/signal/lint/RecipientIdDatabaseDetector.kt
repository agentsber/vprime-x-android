...
class RecipientIdDatabaseDetector : Detector(), SourceCodeScanner {
  ...
  override fun createUastHandler(context: JavaContext): UElementHandler {
    return object : UElementHandler() {
      override fun visitClass(node: UClass) {
        ...
        val implementsReference = node.interfaces.any { it.qualifiedName == "com.vprimex.messenger.database.RecipientIdDatabaseReference" }
  ...
  companion object {
    ...
    private val EXEMPTED_CLASSES = setOf("com.vprimex.messenger.database.RecipientDatabase")
  }
}