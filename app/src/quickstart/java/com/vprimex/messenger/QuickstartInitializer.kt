...
import com.vprimex.messenger.registration.data.QuickstartCredentials
...
object QuickstartInitializer {
  ...
  private val diskCredentialFileName: String
    get() = if (com.vprimex.messenger.util.Environment.IS_STAGING) "staging_credentials.json" else "prod_credentials.json"
