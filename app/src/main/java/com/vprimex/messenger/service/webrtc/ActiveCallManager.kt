...
import com.vprimex.messenger.service.SafeForegroundService
import com.vprimex.messenger.util.DeviceProperties
import com.vprimex.messenger.util.TelephonyUtil
import com.vprimex.messenger.webrtc.CallNotificationBuilder
import com.vprimex.messenger.webrtc.UncaughtExceptionHandlerManager
import com.vprimex.messenger.webrtc.audio.AudioManagerCommand
import com.vprimex.messenger.webrtc.audio.SignalAudioManager
import com.vprimex.messenger.webrtc.audio.SignalAudioManager.Companion.create
...
class ActiveCallManager(
  ...
  class ActiveCallServiceReceiver : BroadcastReceiver() {
    ...
    companion object {
      const val ACTION_DENY = "com.vprimex.messenger.service.webrtc.ActiveCallAction.DENY"
      const val ACTION_HANGUP = "com.vprimex.messenger.service.webrtc.ActiveCallAction.HANGUP"
    }
