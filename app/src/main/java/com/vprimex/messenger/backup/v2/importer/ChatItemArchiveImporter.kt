...
import com.vprimex.messenger.backup.v2.ImportSkips
import com.vprimex.messenger.backup.v2.ImportState
import com.vprimex.messenger.backup.v2.util.toLocalAttachment
...
import com.vprimex.messenger.database.ReactionTable
...
import com.vprimex.messenger.database.model.databaseprotos.CryptoValue
...
import com.vprimex.messenger.database.model.databaseprotos.PaymentTombstone
...
import com.vprimex.messenger.payments.CryptoValueUtil
import com.vprimex.messenger.payments.Direction
import com.vprimex.messenger.payments.FailureReason
import com.vprimex.messenger.payments.State
import com.vprimex.messenger.payments.proto.PaymentMetaData
import com.vprimex.messenger.polls.Voter
...
class ChatItemArchiveImporter(
  ...
  private fun LinkPreview.toLocalLinkPreview(): com.vprimex.messenger.linkpreview.LinkPreview {
    return com.vprimex.messenger.linkpreview.LinkPreview(
      this.url,
      this.title ?: "",
      this.description ?: "",
      this.date ?: 0,
