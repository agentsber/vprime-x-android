...
import com.vprimex.messenger.backup.v2.database.restoreSelfFromBackup
import com.vprimex.messenger.backup.v2.database.restoreWallpaperAttachment
import com.vprimex.messenger.backup.v2.util.ChatStyleConverter
import com.vprimex.messenger.backup.v2.util.isValid
import com.vprimex.messenger.backup.v2.util.isValidUsername
import com.vprimex.messenger.backup.v2.util.parseChatWallpaper
import com.vprimex.messenger.backup.v2.util.toLocal
...
object AccountDataArchiveProcessor {
  ...
  private fun com.vprimex.messenger.mms.SentMediaQuality.toRemoteSentMediaQuality(): AccountData.SentMediaQuality {
    return when (this) {
      com.vprimex.messenger.mms.SentMediaQuality.STANDARD -> AccountData.SentMediaQuality.STANDARD
      com.vprimex.messenger.mms.SentMediaQuality.HIGH -> AccountData.SentMediaQuality.HIGH
    }
  }

  private fun AccountData.SentMediaQuality?.toLocalSentMediaQuality(): com.vprimex.messenger.mms.SentMediaQuality {
    return when (this) {
      AccountData.SentMediaQuality.HIGH -> com.vprimex.messenger.mms.SentMediaQuality.HIGH
      AccountData.SentMediaQuality.STANDARD -> com.vprimex.messenger.mms.SentMediaQuality.STANDARD
      AccountData.SentMediaQuality.UNKNOWN_QUALITY -> com.vprimex.messenger.mms.SentMediaQuality.STANDARD
      null -> com.vprimex.messenger.mms.SentMediaQuality.STANDARD
    }
  }
