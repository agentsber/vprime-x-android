...
import com.vprimex.messenger.billing.upgrade.UpgradeToPaidTierBottomSheet
...
private fun SheetContent(
  ...
  Column(
    ...
    Box {
      Image(
        imageVector = ImageVector.vectorResource(id = com.vprimex.messenger.R.drawable.image_signal_backups),
    ...
    Text(
      text = stringResource(com.vprimex.messenger.R.string.BackupAlertBottomSheet__your_backups_subscription_expired),
      style = MaterialTheme.typography.titleLarge,
      modifier = Modifier.padding(top = 16.dp, bottom = 12.dp)
    )

    Text(
      text = pluralStringResource(id = com.vprimex.messenger.R.plurals.BackupAlertBottomSheet__your_backup_plan_has_expired, daysUntilDeletion, daysUntilDeletion),
    ...
    Text(
      text = stringResource(id = com.vprimex.messenger.R.string.BackupAlertBottomSheet__you_can_begin_paying_for_backups_again),
      textAlign = TextAlign.Center,
      color = MaterialTheme.colorScheme.onSurfaceVariant,
    ...
    Buttons.LargeTonal(
      ...
      Text(text = stringResource(com.vprimex.messenger.R.string.BackupAlertBottomSheet__subscribe_for_s_month, pricePerMonth))
    }
    ...
    TextButton(
      ...
      Text(text = stringResource(id = com.vprimex.messenger.R.string.BackupAlertBottomSheet__not_now))
    }
  }
}
