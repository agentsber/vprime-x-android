...
package com.vprimex.messenger.webrtc.audio
 ...
 *
 * Device availability and active device updates flow from [com.vprimex.messenger.service.webrtc.TelecomCallController] directly
 * to [com.vprimex.messenger.service.webrtc.SignalCallManager.onAudioDeviceChanged], bypassing this class entirely.
 */
@RequiresApi(34)
