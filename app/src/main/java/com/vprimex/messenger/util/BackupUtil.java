...
public class BackupUtil {
  ...
  public static void deleteUnifiedBackups(@NonNull Context context, @Nullable String backupDirectoryPath, @Nullable com.vprimex.messenger.backup.v2.local.AllFilesProgressListener progressListener) {
    if (backupDirectoryPath != null) {
      Uri          backupDirectoryUri = Uri.parse(backupDirectoryPath);
      DocumentFile backupDirectory    = DocumentFile.fromTreeUri(context, backupDirectoryUri);
