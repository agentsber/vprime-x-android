...
import com.vprimex.messenger.util.dynamiclanguage.LanguageString;

import java.util.Locale;

/**
 * @deprecated Use a base activity that uses the {@link com.vprimex.messenger.util.dynamiclanguage.DynamicLanguageContextWrapper}
 */
@Deprecated
