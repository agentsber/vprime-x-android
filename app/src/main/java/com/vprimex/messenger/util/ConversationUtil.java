...
import com.vprimex.messenger.components.settings.app.appearance.appicon.util.AppIconUtility;
...
public final class ConversationUtil {
  ...
  private static final String CATEGORY_SHARE_TARGET = "com.vprimex.messenger.sharing.CATEGORY_SHARE_TARGET";
