...
public class VoiceNotePlaybackService extends MediaSessionService {
  ...
  public static final String ACTION_NEXT_PLAYBACK_SPEED = "com.vprimex.messenger.components.voice.VoiceNotePlaybackService.action.next_playback_speed";
  public static final String ACTION_SET_AUDIO_STREAM    = "com.vprimex.messenger.components.voice.VoiceNotePlaybackService.action.set_audio_stream";
