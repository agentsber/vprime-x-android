...
import com.vprimex.messenger.ShortcutLauncherActivity
import com.vprimex.messenger.attachments.TombstoneAttachment
import com.vprimex.messenger.avatar.fallback.FallbackAvatarDrawable
import com.vprimex.messenger.components.emoji.EmojiStrings
...
import com.vprimex.messenger.conversation.v2.RequestReviewState.GroupReviewState
import com.vprimex.messenger.conversation.v2.RequestReviewState.IndividualReviewState
import com.vprimex.messenger.conversation.v2.data.ConversationDataSource
...
import com.vprimex.messenger.dependencies.AppDependencies.databaseObserver
import com.vprimex.messenger.dependencies.AppDependencies.expiringMessageManager
import com.vprimex.messenger.groups.GroupNotAMemberException
import com.vprimex.messenger.jobs.GroupSendJobHelper
import com.vprimex.messenger.jobs.MultiDeviceViewOnceOpenJob
import com.vprimex.messenger.jobs.UnpinMessageJob
import com.vprimex.messenger.keyboard.KeyboardUtil
import com.vprimex.messenger.keyvalue.SignalStore.Companion.settings
import com.vprimex.messenger.linkpreview.LinkPreview
import com.vprimex.messenger.messagerequests.MessageRequestState
...
import com.vprimex.messenger.profiles.spoofing.ReviewRecipient
...
import com.vprimex.messenger.transport.UndeliverableMessageException
import com.vprimex.messenger.util.AdaptiveBitmapMetrics
import com.vprimex.messenger.util.GroupUtil
...
import com.vprimex.messenger.util.hasSharedContact
import com.vprimex.messenger.util.hasTextSlide
import com.vprimex.messenger.util.isViewOnceMessage
import com.vprimex.messenger.util.requireTextSlide
...
class ConversationRepository(
  ...
  private val oldConversationRepository = com.vprimex.messenger.conversation.ConversationRepository()
