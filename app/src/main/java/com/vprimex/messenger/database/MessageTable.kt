...
import com.vprimex.messenger.attachments.DatabaseAttachment.DisplayOrderComparator
import com.vprimex.messenger.backup.v2.exporters.ChatItemArchiveExporter
import com.vprimex.messenger.contactshare.Contact
import com.vprimex.messenger.conversation.MessageStyler
import com.vprimex.messenger.database.EarlyDeliveryReceiptCache.Receipt
import com.vprimex.messenger.database.MentionUtil.UpdatedBodyAndMentions
import com.vprimex.messenger.database.SignalDatabase.Companion.attachments
import com.vprimex.messenger.database.SignalDatabase.Companion.calls
import com.vprimex.messenger.database.SignalDatabase.Companion.distributionLists
import com.vprimex.messenger.database.SignalDatabase.Companion.groupReceipts
import com.vprimex.messenger.database.SignalDatabase.Companion.groups
import com.vprimex.messenger.database.SignalDatabase.Companion.mentions
import com.vprimex.messenger.database.SignalDatabase.Companion.messages
import com.vprimex.messenger.database.SignalDatabase.Companion.polls
import com.vprimex.messenger.database.SignalDatabase.Companion.reactions
import com.vprimex.messenger.database.SignalDatabase.Companion.recipients
import com.vprimex.messenger.database.SignalDatabase.Companion.storySends
import com.vprimex.messenger.database.SignalDatabase.Companion.threads
import com.vprimex.messenger.database.documents.Document
import com.vprimex.messenger.database.documents.IdentityKeyMismatch
import com.vprimex.messenger.database.documents.IdentityKeyMismatchSet
import com.vprimex.messenger.database.documents.NetworkFailure
import com.vprimex.messenger.database.documents.NetworkFailureSet
import com.vprimex.messenger.database.model.GroupCallUpdateDetailsUtil
import com.vprimex.messenger.database.model.Mention
import com.vprimex.messenger.database.model.MessageExportStatus
...
import com.vprimex.messenger.database.model.ParentStoryId.DirectReply
import com.vprimex.messenger.database.model.ParentStoryId.GroupReply
import com.vprimex.messenger.database.model.Quote
import com.vprimex.messenger.database.model.StoryResult
import com.vprimex.messenger.database.model.StoryType
import com.vprimex.messenger.database.model.StoryType.Companion.fromCode
import com.vprimex.messenger.database.model.StoryViewState
import com.vprimex.messenger.database.model.databaseprotos.AdminDeleteStatus
import com.vprimex.messenger.database.model.databaseprotos.BodyRangeList
import com.vprimex.messenger.database.model.databaseprotos.DecryptedGroupV2Context
import com.vprimex.messenger.database.model.databaseprotos.GV2UpdateDescription
...
import com.vprimex.messenger.database.model.databaseprotos.MessageExportState
import com.vprimex.messenger.database.model.databaseprotos.MessageExtras
import com.vprimex.messenger.database.model.databaseprotos.PinnedMessage
import com.vprimex.messenger.database.model.databaseprotos.PollTerminate
import com.vprimex.messenger.database.model.databaseprotos.ProfileChangeDetails
import com.vprimex.messenger.database.model.databaseprotos.SessionSwitchoverEvent
import com.vprimex.messenger.database.model.databaseprotos.ThreadMergeEvent
import com.vprimex.messenger.dependencies.AppDependencies
import com.vprimex.messenger.groups.GroupMigrationMembershipChange
import com.vprimex.messenger.jobs.OptimizeMessageSearchIndexJob
import com.vprimex.messenger.jobs.ThreadUpdateJob
import com.vprimex.messenger.jobs.TrimThreadJob
import com.vprimex.messenger.keyvalue.SignalStore
import com.vprimex.messenger.linkpreview.LinkPreview
import com.vprimex.messenger.mms.IncomingMessage
import com.vprimex.messenger.mms.MessageGroupContext
import com.vprimex.messenger.mms.MmsException
...
import com.vprimex.messenger.notifications.v2.DefaultMessageNotifier.StickyThread
import com.vprimex.messenger.polls.Poll
import com.vprimex.messenger.polls.PollRecord
import com.vprimex.messenger.recipients.Recipient
import com.vprimex.messenger.recipients.RecipientId
import com.vprimex.messenger.revealable.ViewOnceExpirationInfo
import com.vprimex.messenger.revealable.ViewOnceUtil
import com.vprimex.messenger.sms.GroupV2UpdateMessageUtil
import com.vprimex.messenger.stories.Stories.isFeatureEnabled
...
import com.vprimex.messenger.util.SignalTrace
import com.vprimex.messenger.util.TextSecurePreferences
import com.vprimex.messenger.util.isStory
...
open class MessageTable(context: Context?, databaseHelper: SignalDatabase) : DatabaseTable(context, databaseHelper), MessageTypes, RecipientIdDatabaseReference, ThreadIdDatabaseReference {
   ...
   *
   * Heavily lifted from [com.vprimex.messenger.database.helpers.migration.V191_UniqueMessageMigrationV2].
   */
