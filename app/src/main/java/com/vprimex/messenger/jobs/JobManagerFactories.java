...
import com.vprimex.messenger.jobmanager.impl.ChargingAndBatteryIsNotLowConstraintObserver;
import com.vprimex.messenger.jobmanager.impl.ChargingConstraint;
import com.vprimex.messenger.jobmanager.impl.DataRestoreConstraint;
import com.vprimex.messenger.jobmanager.impl.DataRestoreConstraintObserver;
import com.vprimex.messenger.jobmanager.impl.DecryptionsDrainedConstraint;
import com.vprimex.messenger.jobmanager.impl.DecryptionsDrainedConstraintObserver;
...
import com.vprimex.messenger.jobmanager.impl.NetworkConstraintObserver;
...
import com.vprimex.messenger.jobmanager.impl.NotInCallConstraintObserver;
...
import com.vprimex.messenger.jobmanager.migrations.DeprecatedJobMigration;
import com.vprimex.messenger.jobmanager.migrations.DonationReceiptRedemptionJobMigration;
import com.vprimex.messenger.jobmanager.migrations.GroupCallPeekJobDataMigration;
import com.vprimex.messenger.jobmanager.migrations.PushDecryptMessageJobEnvelopeMigration;
import com.vprimex.messenger.jobmanager.migrations.PushProcessMessageJobMigration;
import com.vprimex.messenger.jobmanager.migrations.RetrieveProfileJobMigration;
import com.vprimex.messenger.jobmanager.migrations.SendReadReceiptsJobMigration;
import com.vprimex.messenger.jobmanager.migrations.SenderKeyDistributionSendJobRecipientMigration;
import com.vprimex.messenger.migrations.AccountConsistencyMigrationJob;
import com.vprimex.messenger.migrations.AccountRecordMigrationJob;
import com.vprimex.messenger.migrations.AepMigrationJob;
import com.vprimex.messenger.migrations.ApplyUnknownFieldsToSelfMigrationJob;
import com.vprimex.messenger.migrations.ArchiveBackupIdReservationMigrationJob;
import com.vprimex.messenger.migrations.AttachmentCleanupMigrationJob;
import com.vprimex.messenger.migrations.AttachmentHashBackfillMigrationJob;
import com.vprimex.messenger.migrations.AttributesMigrationJob;
import com.vprimex.messenger.migrations.AvatarColorStorageServiceMigrationJob;
import com.vprimex.messenger.migrations.AvatarIdRemovalMigrationJob;
import com.vprimex.messenger.migrations.AvatarMigrationJob;
import com.vprimex.messenger.migrations.BackfillCollapsedEventsMigrationJob;
import com.vprimex.messenger.migrations.BackfillDigestsForDuplicatesMigrationJob;
import com.vprimex.messenger.migrations.BackupJitterMigrationJob;
import com.vprimex.messenger.migrations.BackupNotificationMigrationJob;
import com.vprimex.messenger.migrations.BadE164MigrationJob;
import com.vprimex.messenger.migrations.BlobStorageLocationMigrationJob;
import com.vprimex.messenger.migrations.CachedAttachmentsMigrationJob;
import com.vprimex.messenger.migrations.ClearGlideCacheMigrationJob;
import com.vprimex.messenger.migrations.ContactLinkRebuildMigrationJob;
import com.vprimex.messenger.migrations.CopyUsernameToSignalStoreMigrationJob;
import com.vprimex.messenger.migrations.DatabaseMigrationJob;
import com.vprimex.messenger.migrations.DeleteDeprecatedLogsMigrationJob;
import com.vprimex.messenger.migrations.DirectoryRefreshMigrationJob;
import com.vprimex.messenger.migrations.DuplicateE164MigrationJob;
import com.vprimex.messenger.migrations.E164FormattingMigrationJob;
import com.vprimex.messenger.migrations.EmojiDownloadMigrationJob;
import com.vprimex.messenger.migrations.EmojiSearchEnglishLabelsMigrationJob;
import com.vprimex.messenger.migrations.EmojiSearchIndexCheckMigrationJob;
import com.vprimex.messenger.migrations.FixChangeNumberErrorMigrationJob;
import com.vprimex.messenger.migrations.GooglePlayBillingPurchaseTokenMigrationJob;
import com.vprimex.messenger.migrations.IdentityTableCleanupMigrationJob;
import com.vprimex.messenger.migrations.LegacyMigrationJob;
import com.vprimex.messenger.migrations.MigrationCompleteJob;
import com.vprimex.messenger.migrations.OptimizeMessageSearchIndexMigrationJob;
import com.vprimex.messenger.migrations.PassingMigrationJob;
import com.vprimex.messenger.migrations.PinOptOutMigration;
import com.vprimex.messenger.migrations.PinReminderMigrationJob;
import com.vprimex.messenger.migrations.PniAccountInitializationMigrationJob;
import com.vprimex.messenger.migrations.PniMigrationJob;
import com.vprimex.messenger.migrations.PnpLaunchMigrationJob;
import com.vprimex.messenger.migrations.PreKeysSyncMigrationJob;
import com.vprimex.messenger.migrations.ProfileMigrationJob;
import com.vprimex.messenger.migrations.ProfileSharingUpdateMigrationJob;
import com.vprimex.messenger.migrations.QuoteThumbnailBackfillMigrationJob;
import com.vprimex.messenger.migrations.RebuildMessageSearchIndexMigrationJob;
import com.vprimex.messenger.migrations.RecheckPaymentsMigrationJob;
import com.vprimex.messenger.migrations.RecipientSearchMigrationJob;
import com.vprimex.messenger.migrations.ReleaseChannelRecipientFixMigrationJob;
import com.vprimex.messenger.migrations.ResetArchiveTierMigrationJob;
import com.vprimex.messenger.migrations.ResetKeyTransparencyMigrationJob;
import com.vprimex.messenger.migrations.SelfRegisteredStateMigrationJob;
import com.vprimex.messenger.migrations.StickerAdditionMigrationJob;
import com.vprimex.messenger.migrations.StickerDayByDayMigrationJob;
import com.vprimex.messenger.migrations.StickerLaunchMigrationJob;
import com.vprimex.messenger.migrations.StickerMyDailyLifeMigrationJob;
import com.vprimex.messenger.migrations.StickerPackAddition2MigrationJob;
import com.vprimex.messenger.migrations.StorageCapabilityMigrationJob;
import com.vprimex.messenger.migrations.StorageFixLocalUnknownMigrationJob;
import com.vprimex.messenger.migrations.StorageServiceMigrationJob;
import com.vprimex.messenger.migrations.StorageServiceSystemNameMigrationJob;
import com.vprimex.messenger.migrations.StoryViewedReceiptsStateMigrationJob;
import com.vprimex.messenger.migrations.SubscriberIdMigrationJob;
import com.vprimex.messenger.migrations.Svr2MirrorMigrationJob;
import com.vprimex.messenger.migrations.SyncCallLinksMigrationJob;
import com.vprimex.messenger.migrations.SyncChatFoldersMigrationJob;
import com.vprimex.messenger.migrations.SyncDistributionListsMigrationJob;
import com.vprimex.messenger.migrations.SyncKeysMigrationJob;
import com.vprimex.messenger.migrations.TrimByLengthSettingsMigrationJob;
import com.vprimex.messenger.migrations.UpdateSmsJobsMigrationJob;
import com.vprimex.messenger.migrations.UserNotificationMigrationJob;
import com.vprimex.messenger.migrations.UuidMigrationJob;
import com.vprimex.messenger.migrations.WallpaperCleanupMigrationJob;
import com.vprimex.messenger.migrations.WallpaperStorageMigrationJob;
