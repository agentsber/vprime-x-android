...
import com.vprimex.messenger.database.model.ServiceMessageId
...
/**
 * A job that should be enqueued whenever we process a message that we think has arrived "early" (see [com.vprimex.messenger.util.EarlyMessageCache]).
