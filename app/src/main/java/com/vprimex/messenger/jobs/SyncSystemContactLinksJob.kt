...
class SyncSystemContactLinksJob private constructor(parameters: Parameters) : BaseJob(parameters) {
  ...
  companion object {
    ...
    private const val MESSAGE_MIMETYPE = "vnd.android.cursor.item/vnd.com.vprimex.messenger.contact"
    private const val CALL_MIMETYPE = "vnd.android.cursor.item/vnd.com.vprimex.messenger.call"
    private const val VIDEO_CALL_MIMETYPE = "vnd.android.cursor.item/vnd.com.vprimex.messenger.videocall"
