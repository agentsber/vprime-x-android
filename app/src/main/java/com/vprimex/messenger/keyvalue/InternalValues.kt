...
import com.vprimex.messenger.util.Environment.Calling.defaultSfuUrl
...
class InternalValues internal constructor(store: KeyValueStore) : SignalStoreValues(store) {
  ...
  /**
   * Show detailed recipient info in the [com.vprimex.messenger.components.settings.conversation.InternalConversationSettingsFragment].
   */
