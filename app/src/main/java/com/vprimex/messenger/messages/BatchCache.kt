 ...
 * no batching is possible, mostly when the [com.vprimex.messenger.jobs.PushProcessMessageJob] runs.
 */
...
/**
 * This is intended to be used in [IncomingMessageObserver] to batch jobs (e.g., [com.vprimex.messenger.jobs.SendDeliveryReceiptJob])
