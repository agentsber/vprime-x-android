...
import com.vprimex.messenger.jobs.SendRetryReceiptJob
...
object MessageDecryptor {
   ...
   * These can vary from enqueueing jobs to inserting items into the [com.vprimex.messenger.database.PendingRetryReceiptCache].
   */
  fun decrypt(
    context: Context,
