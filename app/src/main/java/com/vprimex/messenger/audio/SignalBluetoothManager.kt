...
import com.vprimex.messenger.webrtc.audio.SignalAudioHandler
 ...
 * reports that to the [com.vprimex.messenger.webrtc.audio.SignalAudioManager], and then handles connecting/disconnecting
 * to the device if requested by [com.vprimex.messenger.webrtc.audio.SignalAudioManager].
 */
