...
import com.vprimex.messenger.avatar.picker.AvatarPickerItem
import com.vprimex.messenger.components.BoldSelectionTabItem
import com.vprimex.messenger.components.ControllableTabLayout
...
class TextAvatarCreationFragment : Fragment(R.layout.text_avatar_creation_fragment) {
  ...
  companion object {
    const val REQUEST_KEY_TEXT = "com.vprimex.messenger.avatar.text.TEXT"
  }
}
