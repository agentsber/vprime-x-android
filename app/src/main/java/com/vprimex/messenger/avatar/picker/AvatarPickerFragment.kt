...
import com.vprimex.messenger.avatar.AvatarBundler
import com.vprimex.messenger.avatar.photo.PhotoEditorActivity
import com.vprimex.messenger.avatar.photo.PhotoEditorFragment
import com.vprimex.messenger.avatar.text.TextAvatarCreationFragment
import com.vprimex.messenger.avatar.vector.VectorAvatarCreationFragment
import com.vprimex.messenger.components.ButtonStripItemView
import com.vprimex.messenger.components.recyclerview.GridDividerDecoration
import com.vprimex.messenger.mediasend.AvatarSelectionActivity
...
class AvatarPickerFragment : Fragment(R.layout.avatar_picker_fragment) {
  ...
  companion object {
    const val REQUEST_KEY_SELECT_AVATAR = "com.vprimex.messenger.avatar.picker.SELECT_AVATAR"
    const val SELECT_AVATAR_MEDIA = "com.vprimex.messenger.avatar.picker.SELECT_AVATAR_MEDIA"
    const val SELECT_AVATAR_CLEAR = "com.vprimex.messenger.avatar.picker.SELECT_AVATAR_CLEAR"
