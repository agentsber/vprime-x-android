...
package com.vprimex.messenger.conversation.plaintext
...
import com.vprimex.messenger.conversation.plaintext.PlaintextExportRepository.PendingAttachment
import com.vprimex.messenger.database.FakeMessageRecords
...
class PlaintextExportRepositoryTest {
  ...
  fun setUp() {
    ...
    val mockLiveRecipient = mockk<com.vprimex.messenger.recipients.LiveRecipient>(relaxed = true)
  ...
  private fun renderMessage(
    message: com.vprimex.messenger.database.model.MmsMessageRecord,
    attachments: List<com.vprimex.messenger.attachments.DatabaseAttachment> = emptyList(),
