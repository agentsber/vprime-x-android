...
import com.vprimex.messenger.attachments.AttachmentSaver.Host
import com.vprimex.messenger.attachments.AttachmentSaver.RequestPermissionResult
import com.vprimex.messenger.attachments.AttachmentSaver.SaveToStorageWarningResult
import com.vprimex.messenger.keyvalue.SignalStore
import com.vprimex.messenger.keyvalue.UiHintValues
import com.vprimex.messenger.testing.CoroutineDispatcherRule
import com.vprimex.messenger.testutil.MockAppDependenciesRule
import com.vprimex.messenger.util.SaveAttachmentUtil
import com.vprimex.messenger.util.SaveAttachmentUtil.SaveAttachmentsResult
...
class AttachmentSaverTest {
  ...
  private val testAttachments: Set<SaveAttachmentUtil.SaveAttachment> = setOf(
    SaveAttachmentUtil.SaveAttachment(
      uri = Uri.parse("content://com.vprimex.messenger/part/111"),
    ...
    SaveAttachmentUtil.SaveAttachment(
      uri = Uri.parse("content://com.vprimex.messenger/part/222"),
      contentType = "image/jpeg",
      date = 1742234384758,
      fileName = null
    )
