...
class TestSignalDatabase(
  ...
  override val signalReadableDatabase: com.vprimex.messenger.database.SQLiteDatabase by lazy {
    TestSignalSQLiteDatabase(supportReadableDatabase)
  }

  override val signalWritableDatabase: com.vprimex.messenger.database.SQLiteDatabase by lazy {
