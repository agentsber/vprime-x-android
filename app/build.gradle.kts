...
android {
  namespace = "com.vprimex.messenger"
  ...
  // Release signing via project properties (set in CI or local.properties)
  if (project.hasProperty("storeFile") && project.hasProperty("storePassword")) {
    signingConfigs.create("release") {
      ...
      keyAlias      = (project.findProperty("keyAlias") ?: "vprime-signal") as String
      keyPassword   = (project.findProperty("keyPassword") ?: project.property("storePassword")) as String
    }
  }
  ...
  defaultConfig {
    ...
    buildConfigField("String", "SIGNAL_URL", "\"https://api.vprime.online\"")
    buildConfigField("String", "STORAGE_URL", "\"https://storage.vprime.online\"")
    buildConfigField("String", "SIGNAL_CDN_URL", "\"https://cdn.vprime.online\"")
    buildConfigField("String", "SIGNAL_CDN2_URL", "\"https://cdn2.vprime.online\"")
    buildConfigField("String", "SIGNAL_CDN3_URL", "\"https://cdn3.vprime.online\"")
    buildConfigField("String", "SIGNAL_CDSI_URL", "\"https://cdsi.vprime.online\"")
    buildConfigField("String", "SIGNAL_SERVICE_STATUS_URL", "\"uptime.vprime.online\"")
    buildConfigField("String", "SIGNAL_SVR2_URL", "\"https://svr2.vprime.online\"")
    ...
    testInstrumentationRunner = if (project.hasProperty("imoTests")) {
      "com.vprimex.messenger.testing.incomingmessageobserver.IncomingMessageObserverTestRunner"
    } else {
      "com.vprimex.messenger.testing.SignalTestRunner"
    }
  ...
  buildTypes {
    ...
    create("benchmark") {
      ...
      manifestPlaceholders["applicationClass"] = "com.vprimex.messenger.BenchmarkApplicationContext"
    }
    ...
    create("mocked") {
      ...
      manifestPlaceholders["applicationClass"] = "com.vprimex.messenger.ApplicationContext"
    }
